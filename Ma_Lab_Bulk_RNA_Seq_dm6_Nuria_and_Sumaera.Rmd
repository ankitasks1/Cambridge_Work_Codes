...
ggpubr::ggarrange(plotlist = MA_plot_nuria_list, ncol=11, nrow=6, common.legend = F, labels=names(MA_plot_nuria_list), vjust = 1,hjust=-0.5,font.label = list(size = 10, color = "black", face = "bold", family = NULL))
dev.off()
```
...
pdf(file = "nuria_gobp_barlot_plot_list_rnaseq.pdf", height = 20, width = 40)
ggpubr::ggarrange(plotlist = goterm_barplot_nuria_list, ncol=5, nrow=5, common.legend = F, labels=names(goterm_barplot_nuria_list), vjust = 1,hjust=-0.5,font.label = list(size = 8, color = "black", face = "bold", family = NULL))
dev.off()
```
...
pdf(file = "sumaera_maplot_plot_list_rnaseq_new.pdf", height = 50, width = 50)
ggpubr::ggarrange(plotlist = MA_plot_sumaera_list, ncol=11, nrow=6, common.legend = F, labels=names(MA_plot_sumaera_list), vjust = 1,hjust=-0.5,font.label = list(size = 10, color = "black", face = "bold", family = NULL))
dev.off()
```
...
pdf(file = "sumaera_gobp_barlot_plot_list_rnaseq.pdf", height = 20, width = 40)
ggpubr::ggarrange(plotlist = goterm_barplot_sumaera_list, ncol=5, nrow=5, common.legend = F, labels=names(goterm_barplot_sumaera_list), vjust = 1,hjust=-0.5,font.label = list(size = 8, color = "black", face = "bold", family = NULL))
dev.off()
```
